...
(function (document) {
  ...
  function updateInvoice() {
    ...
    cells = document.querySelectorAll(
      "table.balance td:last-child span:last-child"
    );
    ...
    cells[2].innerHTML = document.querySelector(
      "table.meta tr:last-child td:last-child span:last-child"
    ...
    for (
      a = document.querySelectorAll("span[data-prefix] + span"), i = 0;
      a[i];
      ++i
    )
